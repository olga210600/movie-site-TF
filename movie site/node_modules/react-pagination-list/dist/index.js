...
var Main = React.memo(function (props) {
    ...
    var _showListPage = function (totalPage) {
        var firstPage = 1, lastPage = totalPage, elmLastPage = (React.createElement("li", { key: lastPage, title: "" + lastPage, onClick: function () { return _onChangePage(lastPage, "last"); }, className: styles.kPaginationItem }, lastPage)), elmFirstPage = (React.createElement("li", { key: firstPage, title: "" + firstPage, onClick: function () { return _onChangePage(firstPage, "first"); }, className: styles.kPaginationItem + " " + (currentPage === 1 ? styles.kPaginationActive : "") }, firstPage)), elmIconJumpNext = null, elmIconJumpPrev = null;
        ...
        if (totalPage > jump) {
            //set icon jump next
            elmIconJumpNext = (React.createElement("li", { key: "jump_next", onClick: _onGetJumpNext, title: "Jump Next", className: styles.kPaginationItem + " " + styles.kPaginationJumpNext },
                React.createElement("i", null,
                    React.createElement("svg", { viewBox: "64 64 896 896", focusable: "false", "data-icon": "double-right", width: "1em", height: "1em", fill: "currentColor", "aria-hidden": "true" },
                        React.createElement("path", { d: "M533.2 492.3L277.9 166.1c-3-3.9-7.7-6.1-12.6-6.1H188c-6.7 0-10.4 7.7-6.3 12.9L447.1 512 181.7 851.1A7.98 7.98 0 0 0 188 864h77.3c4.9 0 9.6-2.3 12.6-6.1l255.3-326.1c9.1-11.7 9.1-27.9 0-39.5zm304 0L581.9 166.1c-3-3.9-7.7-6.1-12.6-6.1H492c-6.7 0-10.4 7.7-6.3 12.9L751.1 512 485.7 851.1A7.98 7.98 0 0 0 492 864h77.3c4.9 0 9.6-2.3 12.6-6.1l255.3-326.1c9.1-11.7 9.1-27.9 0-39.5z" }))),
                React.createElement("a", null, "•••")));
            // set icon jump prev
            elmIconJumpPrev = (React.createElement("li", { key: "jump_prev", onClick: _onGetJumpPrev, title: "Jump Prev", className: styles.kPaginationItem + " " + styles.kPaginationJumpPrev },
                React.createElement("i", null,
                    React.createElement("svg", { viewBox: "64 64 896 896", focusable: "false", "data-icon": "double-left", width: "1em", height: "1em", fill: "currentColor", "aria-hidden": "true" },
                        React.createElement("path", { d: "M272.9 512l265.4-339.1c4.1-5.2.4-12.9-6.3-12.9h-77.3c-4.9 0-9.6 2.3-12.6 6.1L186.8 492.3a31.99 31.99 0 0 0 0 39.5l255.3 326.1c3 3.9 7.7 6.1 12.6 6.1H532c6.7 0 10.4-7.7 6.3-12.9L272.9 512zm304 0l265.4-339.1c4.1-5.2.4-12.9-6.3-12.9h-77.3c-4.9 0-9.6 2.3-12.6 6.1L490.8 492.3a31.99 31.99 0 0 0 0 39.5l255.3 326.1c3 3.9 7.7 6.1 12.6 6.1H836c6.7 0 10.4-7.7 6.3-12.9L576.9 512z" }))),
                React.createElement("a", null, "•••")));
        }
        var listPage = arrItemPage.map(function (_item, index) {
            var pagePos = calNumberPage(countJump, ++index);
            return (React.createElement("li", { title: "" + pagePos, className: styles.kPaginationItem + " " + (currentPage === pagePos ? styles.kPaginationActive : ""), onClick: function () { return _onChangePage(pagePos); }, key: pagePos }, pagePos));
        });
        if (totalPage > 5) {
            var elmJumpNextPage = (React.createElement(React.Fragment, { key: "wrap_jump_next" }, countJump * jump < totalPage ? (React.createElement(React.Fragment, null,
                elmIconJumpNext,
                elmLastPage)) : null));
            var elmJumpPrevPage = (React.createElement(React.Fragment, { key: "wrap_jump_prev" },
                elmFirstPage,
                elmIconJumpPrev));
            if (countJump > 1 || flagEnd)
    ...
    var showListPaginate = function () {
        return pageSize && pageSize !== 0 ? (React.createElement("ul", { className: styles.kPaginationListPage },
            React.createElement("li", { className: styles.kPaginationPrev + " " + (currentPage !== 1 ? "" : "" + styles.kPrevDisabled), onClick: _onPrevPage },
                React.createElement("i", { className: styles.kicon + " " + styles.kiconLeft },
                    React.createElement("svg", { viewBox: "64 64 896 896", focusable: "false", "data-icon": "left", width: "1em", height: "1em", fill: "currentColor", "aria-hidden": "true" },
                        React.createElement("path", { d: "M724 218.3V141c0-6.7-7.7-10.4-12.9-6.3L260.3 486.8a31.86 31.86 0 0 0 0 50.3l450.8 352.1c5.3 4.1 12.9.4 12.9-6.3v-77.3c0-4.9-2.3-9.6-6.1-12.6l-360-281 360-281.1c3.8-3 6.1-7.7 6.1-12.6z" })))),
            _showListPage(totalPage),
            React.createElement("li", { className: styles.kPaginationNext + " " + (currentPage !== totalPage ? "" : "" + styles.kNextDisabled), onClick: _onNextPage },
                React.createElement("i", { className: styles.kicon + " " + styles.kiconRight },
                    React.createElement("svg", { viewBox: "64 64 896 896", focusable: "false", "data-icon": "right", width: "1em", height: "1em", fill: "currentColor", "aria-hidden": "true" },
                        React.createElement("path", { d: "M765.7 486.8L314.9 134.7A7.97 7.97 0 0 0 302 141v77.3c0 4.9 2.3 9.6 6.1 12.6l360 281.1-360 281.1c-3.9 3-6.1 7.7-6.1 12.6V883c0 6.7 7.7 10.4 12.9 6.3l450.8-352.1a31.96 31.96 0 0 0 0-50.4z" })))))) : (React.createElement("div", null));
    };
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: styles.kPagination },
            React.createElement("div", { className: layout === "vertical"
                    ? styles.kPaginationListItemVertical
                    : styles.kPaginationListItemHorizontal }, arrayList.map(function (item, key) { return props.renderItem(item, key); })),
            data.length > 0 && showListPaginate())));
});
Main.propTypes = {
