...
var Main = memo(function (props) {
    var data = props.data, pageSize = props.pageSize, layout = props.layout, _a = useState([]), arrayList = _a[0], setArrayList = _a[1], _b = useState([]), arrItemPage = _b[0], setArrItemPage = _b[1], _c = useState(1), totalPage = _c[0], setTotalPage = _c[1], _d = useState(false), flagEnd = _d[0], setFlagEnd = _d[1];
    ...
    return (createElement(Fragment, null,
        createElement("div", { className: styles.kPagination },
            createElement("div", { className: layout === "vertical"
